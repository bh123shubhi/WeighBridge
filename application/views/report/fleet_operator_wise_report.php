 <!-- Page header --> 
    ...
    <div class="content"> 
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="mb-3">Fleet Operator Report</h5>
          <form name="fleet_wise_report_form" action="<?php echo site_url('report') . $url; ?>" method="post" _lpchecked="1">
            <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                  <label>Fleet Operator</label>
                   <select data-placeholder="Select Fleet Operator" class="form-control select-search" name="fleetoperator" data-fouc >
                    <option></option>
                    <option value="All">All</option>
                    <?php
                    if(count($fleetarr)>0){
                    foreach($fleetarr as $key=>$value){?>
                        <option value="<?php echo $value['fleetoperator'];?>"><?php echo $value['fleetoperator'];?></option>
                  <?php  }}
                    ?>
                  </select>
                </div>
      ...
      <div class="card">
        <div class="card-header justify-contect-center text-center">
          <h5 class="card-title">Fleet Operator Wise Wise Report of Vehicles Coming at SLF From</h5>
