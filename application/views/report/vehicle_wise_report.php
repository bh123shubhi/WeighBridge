 <!-- Page header --> 
    ...
    <div class="content"> 
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="mb-3">Vehicle Wise Report</h5>
          <form name="fleet_wise_report_form" action="<?php echo site_url('report') . $url; ?>" method="post" _lpchecked="1">
            <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                  <label>Vehicle No.</label>
                   <select data-placeholder="Select Vehicle" class="form-control select-search" name="vehicle_no" data-fouc >
                    <option></option>
                    <option value="All">All</option>
                    <?php
                    if(count($vehiclearr)>0){
                    foreach($vehiclearr as $key=>$value){?>
                        <option value="<?php echo $value['id'].'-'.$value['type'];?>"><?php echo $value['registration_no'];?></option>
                  <?php  }}
                    ?>
                  </select>
                </div>
      ...
      <div class="card">
        <div class="card-header justify-contect-center text-center">
          <h5 class="card-title">Vehicle Wise Wise Report of Vehicles Coming at SLF From</h5>
