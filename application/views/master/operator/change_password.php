    ...
    <div class="page-header page-header-light">
      <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
          <div class="breadcrumb"> <a href="index.html" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Home</a> <span class="breadcrumb-item active">Profile</span> </div>
										...
										<div class="form-group">
											<div class="row">
												<div class="col-md-6">
													...
													<input type="text" value="<?php echo !empty($result['value']['username'])?$result['value']['username']:'';?>" readonly="readonly" class="form-control">
												</div>
                                                <div class="col-md-6">
