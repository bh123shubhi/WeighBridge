    ...
    <div class="page-header page-header-light">
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
            <div class="d-flex">
                <div class="breadcrumb"> <a href="<?php echo base_url(); ?>dashboard" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Home</a> <span class="breadcrumb-item ">Operator List</span> <span class="breadcrumb-item active"> Add Operator </span> </div>
                <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a> </div>
        </div>
    </div>
    <!-- /page header --> 
    <?php
        $heading=isset($result['value']['id'])?'Edit Operator':'Add Operator';
    ?>
    <!-- Content area -->
    <div class="content"> 
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="" name="save_operator" method="post" action="<?php echo site_url('master') . $url; ?>">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="username" id="operator_username" placeholder="Enter Unique Username" value="<?php echo isset($result['value']['username']) ? $result['value']['username'] : ''; ?>" required>
                                <p id="opusername_text" style="color:red">UserName Already Exists</p>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-right">
                                <button type="submit" class="btn btn-primary legitRipple" id="operator_submit">Submit <i class="icon-paperplane ml-2"></i></button>
                            </div>
                        </div>
                    </div>
                </form>
