<div class="page-header page-header-light">
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
        <div class="d-flex">
            <div class="breadcrumb"> <a href="<?php echo base_url(); ?>dashboard" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Home</a> <span class="breadcrumb-item ">Garbage Category List</span> <span class="breadcrumb-item active"> Add Garbage </span> </div>
            <a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a> </div>
    </div>
</div>
<!-- /page header -->
<?php
$heading=isset($result['value']['id'])?'Edit Garbage':'Add Garbage';
?> 
<!-- Content area -->
<div class="content"> 
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="" name="save_garbage" action="<?php echo site_url('master') . $url; ?>" method="post">

                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Garbage Name</label>
                            <input class="form-control" type="text" name="garbage" placeholder="Enter Garbage Name" value="<?php echo isset($result['value']['garbage']) ? $result['value']['garbage'] : ''; ?>" required>
                        </div>
